...
"border: 1.5px solid rgb(141, 156, 201);"));
        ...
        verticalLayoutWidget->setGeometry(QRect(0, 0, 611, 461));
        ...
        A->setFont(font3);
        A->setStyleSheet(QString::fromUtf8("QScrollBar:vertical::up-arrow{image:/myimage up path/; with:40px; height:40px;}\n"
...
"QScrollBar:vertical::handle{ border: 3px solid #5E749C;text-align: top;padding: 4px;border-radius: 5px; border-bottom-left-radius: 5px;background: blu;with:40px; height:80px;}"));
        A->setInputMethodHints(Qt::ImhDigitsOnly);
        ...
        A->setAutoScrollMargin(1);
        A->setRowCount(0);
        A->setColumnCount(0);
        A->horizontalHeader()->setMinimumSectionSize(50);
        A->horizontalHeader()->setDefaultSectionSize(50);
        A->verticalHeader()->setVisible(false);
        A->verticalHeader()->setMinimumSectionSize(30);
        A->verticalHeader()->setDefaultSectionSize(30);
